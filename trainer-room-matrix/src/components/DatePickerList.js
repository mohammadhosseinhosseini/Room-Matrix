...
function DatePickerList({ dates, setDates }) {
    const handleChangeStartDate = (date, index) => {
        setDates((pre) => {
            const newDates = [...pre]
            newDates[index].start_date = new Date(date)
            return newDates
        })
    }
    ...
    const handleChangeEndDate = (date, index) => {
        setDates((pre) => {
            const newDates = [...pre]
            newDates[index].end_date = new Date(date)
            return newDates
        })
    }
    const handleChangeStartTime = (date, index) => {
        setDates((pre) => {
            const newDates = [...pre]
            newDates[index].start_time = new Date(date)
            return newDates
        })
    }
    ...
    const handleChangeEndTime = (date, index) => {
        setDates((pre) => {
            ...
            newDates[index].end_time = new Date(date)
            return newDates
        })
    }
    ...
    const handleCopyDate = (index) => {
        setDates((pre) => {
            ...
            newDate.start_date = new Date(
                dayjs(newDate.start_date).add(1, 'day')
            )
            newDate.end_date = new Date(dayjs(newDate.end_date).add(1, 'day'))
            newDates.splice(index + 1, 0, newDate)
            return newDates
        })
    }
