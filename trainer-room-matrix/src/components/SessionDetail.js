...
const siteUrl = 'https://bosch-mital.pixelmechanics-dev.de'
const getSesstionTypeName = (session_type, course_id) => {
                ...
                <Box sx={style}>
                    <div className='mb-4'>
                        <IconButton
                            ...
                            color='error'
                        >
                            <CloseTwoToneIcon style={{ fontSize: 30 }} />
                        </IconButton>
                    </div>
                    <div className='row'>
                        <div className='col-4'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-8'>
                            {getSesstionTypeName(session.session_type)}
                        </div>
                    </div>
                    <hr />
                    <div className='row'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-8'>
                            <Button
                                ...
                                onClick={() => {
                                    window.open(
                                        `${siteUrl}/pmadmin/catalog/product/edit/id/${session.course.id}`,
                                        '_blank'
                                    )
                                }}
                            >
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    window.open(
                                        `${siteUrl}/index.php/catalog/product/view/id/${session.course.id}`,
                                        '_blank'
                                    )
                                }}
                            >
